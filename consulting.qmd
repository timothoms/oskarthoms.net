...
Starting again in July 2026, I am available to provide the following consulting services:
...
-   Building datasets and data collection, incl. automated approaches (webscraping, APIs, etc)

-   Database management 

-   Building data websites with Quarto and Shiny (web-based interactive data apps)

-   Teaching R workshops (incl. Tidyverse, git/GitHub integration, Quarto, RStudio, Positron)
...
-   Sixteen years of experience coding extensively in the R statistical programming language
